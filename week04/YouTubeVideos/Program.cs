...
class Comment { public string Name { get; set; } public string Text { get; set; }
...
class Video { public string Title { get; set; } public string Author { get; set; } public int Length { get; set; } // in seconds private List<Comment> comments;
...
class Program { static void Main() { Console.WriteLine("YouTube Video Tracker\n");
